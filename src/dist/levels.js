...
var embed_1 = require("./utils/embed");
...
var Level = /** @class */ (function () {
                ...
                this.entity.on('message', function (message) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 9:
                                error_1 = _a.sent();
                                this.entity.on("messasge", function (message) { return __awaiter(_this, void 0, void 0, function () {
                                    var user, embed;
                                    return __generator(this, function (_a) {
                                        if (message) {
                                            user = message.author;
                                            embed = embed_1.Embeds.errorEmbed(error_1, this.footer);
    ...
    Level.prototype.showlevel = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            var usernameDoc, userId, userDoc, commandString, userData, response, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        response = "User level: " + userData.level + " (XP: " + userData.xp + ")";
                        return [4 /*yield*/, this.send.sendUserMessage(response)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
