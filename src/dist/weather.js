...
var Weather = /** @class */ (function () {
    ...
    Weather.prototype.nation = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.Send.sendUserMessage('This is the main /weather command. Use subcommands like `/weather search`')];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
    ...
    Weather.prototype.search = function (location, units) {
        if (units === void 0) { units = 'metric'; }
        return __awaiter(this, void 0, void 0, function () {
            var commandString, apiKey, url, response, weatherData, embed, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 5]);
